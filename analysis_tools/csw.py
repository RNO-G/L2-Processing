...
class CSW:
    ...
    def get_arrival_delays_AraRoot_xcorr(
        ...
        for ch_ID in channels_to_include:
            ...
            if ch_ID == reference_ch:
                ...
                #xcorr_times, xcorr_volts = self.get_correlation_function(channel_signals, channel_times, channels_to_include, ch_ID, reference_ch, solution, channel_positions, cable_delays, pts, ttcs)
    ...
    def run(self, event, station, detectorpath, station_id, channels_to_include, solution, ttcs, reco_results, max_corr, score, t_ab):
        ...
        #channel_times, channel_signals = dedisperse.run(event, station, channels_to_include, phase_splines)
        tstop_new = time.time()
        #print(tstop_new-tstart_new, "dedisperse")
        ...
        tstop_new = time.time()
        #print(tstop_new-tstart_new, "arrival_del_reco")
        ...
        tstop_new = time.time()
        #print(tstop_new-tstart_new, "arrival_del")
        ...
        tstop_new = time.time()
        #print(tstop_new-tstart_new, "rolling")
